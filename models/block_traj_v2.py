...
class GFlowNet(nn.Module):
    """
    Version 2 du GFlowNet : héritée de la baseline, cette classe intègre
    un mécanisme pour bloquer les trajectoires dont le coût excède le budget
    à chaque étape, éliminant ainsi les chemins impossibles.
    """
    def __init__(self,
                 num_items: int,
    ...
    def generate_trajectories(self,
        ...
        for i in range(num_items):
            ...
            remaining_budget -= t[:, i].unsqueeze(-1) * action
